...
import com.bignerdranch.android.newfirebasedeneme.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.bignerdranch.android.newfirebasedeneme",MODE_PRIVATE);
        trackBoolean = false;
